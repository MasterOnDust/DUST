...
def resample_monthly(dset, squeeze_numpoint=True):
    ...
    num_date = int(date2num(date_str, 'hours since 1900-01-01 00:00:00.0', calendar='gregorian'))
    dset = dset.assign_coords(time=np.array(num_date))
    dset['time'].attrs = dict(units='hours since 1900-01-01 00:00:00.0',calendar='gregorian')
