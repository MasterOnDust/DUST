...
def multi_flexpart_flexdust(path, nc_files, flexdust, point_spec, **kwargs):
    ...
    field = ncfile.createVariable(
        f_name, "f4", ("time", "btime", "lat", "lon"), **kwargs
    )
...
def multi_flexpart_flexdust_dask(xr_flexpart, xr_flexdust, point_spec):
    ...
    attrs = dict(
        title="FLEXPART * FLEXDUST multiplied SSR",
...
if __name__ == "__main__":
    ...
    multi_flexpart_flexdust(
        "/mnt/c/Users/oveha/Documents/test_parallel.nc",
        ncfiles,
        "/mnt/c/Users/oveha/Documents/dust_2019_ISRIC/",
        0,
        zlib=True,
    )
